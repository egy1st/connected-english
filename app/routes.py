...
if CDN:
    STATIC_URL = 'https://cdn.connectedenglish.net/static/'
else:
...
def quiz(name='1', lang=USER_LANG):
    ...
    words = []
    en_file =  'app/static/ted/subtitles/webvtt/en/' + name + '.vtt'
...
def talk(name='1', lang=USER_LANG):
    ...
    en_file =  'app/static/ted/subtitles/webvtt/en/' + name + '.vtt'
    en_sync =  'app/static/ted/subtitles/sync/en/' + name + '.vtt'
    ...
    ar_file =  'app/static/ted/subtitles/webvtt/ar/' + name + '.vtt'
    ar_sync =  'app/static/ted/subtitles/sync/ar/' + name + '.vtt'
    ...
    return render_template(template, name=name, title=title, img_url=img_url,trans=trans, results=res, sentences=pagination_sent, page=page, per_page=per_page, pagination=pagination, STATIC_URL=STATIC_URL)
